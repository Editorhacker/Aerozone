...
const DataPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res1 = await fetch("https://aerozone-backend.onrender.com/api/data/get-data");
        const excelData = await res1.json();
        setRows(excelData);
        setFilteredRows(excelData);

        const res2 = await fetch("https://aerozone-backend.onrender.com/api/data/get-indent");
